    ...
    for (final persona in defaultPersonas) {
      await _database.upsertPersona(
        PersonasTableCompanion.insert(
          ...
          apiConfigId: persona.apiConfigId,
    ...
    try {
      ...
      await _database.upsertPersona(
        PersonasTableCompanion.insert(
          ...
          apiConfigId: newPersona.apiConfigId,
    ...
    try {
      ...
      await _database.upsertPersona(
        PersonasTableCompanion(
          ...
          apiConfigId: Value(updatedPersona.apiConfigId),
    ...
    try {
      ...
      await _database.upsertPersona(
        PersonasTableCompanion.insert(
          ...
          apiConfigId: duplicatedPersona.apiConfigId,
